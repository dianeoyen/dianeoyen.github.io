...
News
======
Excited to announce the Workshop on Drawings and abstract Imagery: Representation and Analysis (DIRA) at ECCV 2022! [More info](https://sites.google.com/view/eccv-dira){: .btn}
-->
...
Publications
======
See longer [publications list](http://public.lanl.gov/doyen/publications).
...
======
* Organizer, LANL [Applied Machine Learning Summer Research Fellowship](http://aml.lanl.gov)
* [Scientist Ambassador](http://www.lanl.gov/museum/teachers/scientist-ambassadors.php), [Bradbury Science Museum](http://www.lanl.gov/museum)
-->
